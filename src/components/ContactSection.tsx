      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-600 text-lg mt-4 max-w-2xl mx-auto">
            I&apos;m always interested in discussing research opportunities, collaborations, and new projects in sustainable finance and data analysis.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-purple-600 text-sm">Available for remote collaboration</p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-8 bg-gray-50 p-6 rounded-lg">
              <h4 className="font-semibold text-gray-900 mb-4">Areas of Collaboration</h4>
        ...
        <div className="mt-16 bg-gradient-to-r from-blue-600 to-blue-700 p-8 rounded-lg text-white text-center">
          ...
          <p className="text-blue-100 mb-6 max-w-2xl mx-auto">
            I&apos;m always excited to work on challenging research projects, data analysis tasks, and academic collaborations. 
            Let&apos;s discuss how we can work together to create impactful research.
          </p>
